<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('index_diy_preview');
0
|| checktplrefresh('data/diy/./template/xinyun_door_001//portal/index_diy_preview.htm', './template/default/common/header.htm', 1470316311, 'diy', './data/template/9_diy_portal_index_diy_preview.tpl.php', 'data/diy/./template/xinyun_door_001/', 'portal/index_diy_preview')
|| checktplrefresh('data/diy/./template/xinyun_door_001//portal/index_diy_preview.htm', './template/default/common/footer.htm', 1470316311, 'diy', './data/template/9_diy_portal_index_diy_preview.tpl.php', 'data/diy/./template/xinyun_door_001/', 'portal/index_diy_preview')
|| checktplrefresh('data/diy/./template/xinyun_door_001//portal/index_diy_preview.htm', './template/default/common/header_common.htm', 1470316311, 'diy', './data/template/9_diy_portal_index_diy_preview.tpl.php', 'data/diy/./template/xinyun_door_001/', 'portal/index_diy_preview')
|| checktplrefresh('data/diy/./template/xinyun_door_001//portal/index_diy_preview.htm', './template/default/common/header_qmenu.htm', 1470316311, 'diy', './data/template/9_diy_portal_index_diy_preview.tpl.php', 'data/diy/./template/xinyun_door_001/', 'portal/index_diy_preview')
|| checktplrefresh('data/diy/./template/xinyun_door_001//portal/index_diy_preview.htm', './template/default/common/pubsearchform.htm', 1470316311, 'diy', './data/template/9_diy_portal_index_diy_preview.tpl.php', 'data/diy/./template/xinyun_door_001/', 'portal/index_diy_preview')
;
block_get('90,91,92,74');?>
...
<div id="wp" class="wp">
<style id="diy_style" type="text/css">#portal_block_74 { margin:10px !important;}</style>
<div class="wp">
<!--[diy=diy200]--><div id="diy200" class="area"></div><!--[/diy]-->
</div>
<div class="cl wp" style="margin-top:10px;">
    <div class="xinyun_oneleft_boxone">
    <!--[diy=xinyun_door_001_10]--><div id="xinyun_door_001_10" class="area"><div id="frameWYMMsk" class="frame move-span cl frame-1"><div id="frameWYMMsk_left" class="column frame-1-c"><div id="frameWYMMsk_left_temp" class="move-span temp"></div><?php block_display('90');?></div></div></div><!--[/diy]-->
    </div>
</div>
<div class="cl wp mt8 xinyun_photo">
     <h2 class="xinyun_title"><strong>最新帖子</strong><span class="more"><a href="#" target="_blank">更多</a></span></h2>
     <!--[diy=xinyun_door_001_22]--><div id="xinyun_door_001_22" class="area"><div id="frameYK2XVz" class="frame move-span cl frame-1"><div id="frameYK2XVz_left" class="column frame-1-c"><div id="frameYK2XVz_left_temp" class="move-span temp"></div><?php block_display('91');?></div></div></div><!--[/diy]-->
</div>
<div class="cl wp mt8 xinyun_photo">
     <h2 class="xinyun_title"><strong>精彩专题</strong><span class="more"><a href="#" target="_blank">更多</a></span></h2>
     <!--[diy=xinyun_door_001_23]--><div id="xinyun_door_001_23" class="area"><div id="frameL2CB34" class="frame move-span cl frame-1-1"><div id="frameL2CB34_left" class="column frame-1-1-l"><div id="frameL2CB34_left_temp" class="move-span temp"></div><?php block_display('92');?></div><div id="frameL2CB34_center" class="column frame-1-1-r"><div id="frameL2CB34_center_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
</div>
<div class="cl wp mt8 xinyun_link mb8">
     <h2 class="xinyun_title"><strong>友情链接</strong><span class="more"></span></h2>
     <!--[diy=xinyun_door_001_24]--><div id="xinyun_door_001_24" class="area"><div id="framey8r9hG" class="frame move-span cl frame-1"><div id="framey8r9hG_left" class="column frame-1-c"><div id="framey8r9hG_left_temp" class="move-span temp"></div><?php block_display('74');?><div id="frameHj4LJj" class="frame move-span cl frame-1"><div id="frameHj4LJj_left" class="column frame-1-c"><div id="frameHj4LJj_left_temp" class="move-span temp"></div></div></div></div></div></div><!--[/diy]-->
</div>
<div class="wp">
