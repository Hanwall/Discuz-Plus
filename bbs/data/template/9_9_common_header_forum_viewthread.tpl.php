...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1470319732, '9', './data/template/9_9_common_header_forum_viewthread.tpl.php', './template/xinyun_door_001', 'common/header_forum_viewthread')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1470319732, '9', './data/template/9_9_common_header_forum_viewthread.tpl.php', './template/xinyun_door_001', 'common/header_forum_viewthread')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1470319732, '9', './data/template/9_9_common_header_forum_viewthread.tpl.php', './template/xinyun_door_001', 'common/header_forum_viewthread')
;?>
